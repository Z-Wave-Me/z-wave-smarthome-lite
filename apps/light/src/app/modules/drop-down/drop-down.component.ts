...
export class DropDownComponent implements OnInit, AfterViewInit {
  @ContentChild(DropDownHeadComponent, { read: ElementRef }) dropDownHead?: ElementRef;
  @ContentChild(DropDownContentComponent, { read: ElementRef }) dropDownContent?: ElementRef;
  constructor(
  ...
  ngAfterViewInit(): void {
    if (this.dropDownHead && this.dropDownContent) {
      ...
      throw new Error('DropDownHeadComponent && DropDownContentComponent must be implemented in DropDownComponent');
    }
  }
