...
import { ElementControlRoutingModule } from '@components/element-control/element-control-routing.module';
...
@NgModule({
  declarations: [ElementControlComponent, DefaultElementControlComponent, SwitchMultilevelControlComponent],
